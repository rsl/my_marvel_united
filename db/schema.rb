...
ActiveRecord::Schema[7.0].define(version: 2022_05_16_162535) do
  ...
  create_table "boxes", force: :cascade do |t|
    ...
    t.text "description"
    t.string "slug"
    t.index ["slug"], name: "index_boxes_on_slug", unique: true
  end
  ...
  add_foreign_key "heroes", "boxes"
  add_foreign_key "locations", "boxes"
  add_foreign_key "villains", "boxes"
end
